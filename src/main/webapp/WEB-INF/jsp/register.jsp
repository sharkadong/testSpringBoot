...
<form class="form-inline" action="welcome" method="post">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleInputEmail3" name="nickname" placeholder="用户名">
  </div><br /><br />
  <div class="form-group">
  ...
  <div class="form-group">
    <label class="sr-only" for="exampleInputPassword3">密码</label>
    <input type="password" class="form-control" id="exampleInputPassword3" name="repassword" placeholder="确认密码">
  </div><br /><br />
  <div class="checkbox">
    <label>
